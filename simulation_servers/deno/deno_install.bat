...
start cmd /k "deno cache G:/WebStormWS/web-hansheng-IoT-project/simulation_servers/deno/src/database/mongo/simulation_servers_deno/upload_file_sri/UploadFileSRI.esm.mts"
start cmd /k "deno cache G:/WebStormWS/web-hansheng-IoT-project/simulation_servers/deno/src/database/mongo/tools/MongooseConfig.esm.mts"
start cmd /k "deno cache G:/WebStormWS/web-hansheng-IoT-project/simulation_servers/deno/src/database/mongo/tools/MongooseConnect.esm.mts"
start cmd /k "deno cache G:/WebStormWS/web-hansheng-IoT-project/simulation_servers/deno/src/services/upload_resources_service/UpdateFileSRI.esm.mts"
start cmd /k "deno cache G:/WebStormWS/web-hansheng-IoT-project/simulation_servers/deno/src/services/GetJSON.esm.mts"
