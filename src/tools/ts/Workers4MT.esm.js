...
class SWorker4MT {
   ...
   *   url: 'http://localhost:8082/sn-data-center-platform-micro-front-web/dist/devServer/js/TestJS.js',<br />
...
class SWRegistration {
   ...
   *
   *  icon: 'https://e6093c81.ap.ngrok.io/sn-data-center-platform-micro-front-web/dist/test/img/1.png', // 字符串，一个USVString，包含要与操作一起显示的图标的URL。<br /><br />
   *
