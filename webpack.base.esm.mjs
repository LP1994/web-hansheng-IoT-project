 ...
 * 例如：<br />
 * path.resolve( __dirname, './src/assets/' )，最后解析成：G:\WebStormWS\web-hansheng-IoT-project\src\assets
 * path.join( __dirname, './src/assets/' )，最后解析成：G:\WebStormWS\web-hansheng-IoT-project\src\assets\
 * 有或是没有最后的“\”在具体应用时很重要！不然容易出现不如你所愿的现象。<br />
 * 6、当设置文件夹的路径别名时，用path.resolve设置时，其值包不包含最后的“/”都没关系，因为最后生成的路径（如：G:\WebStormWS\web-hansheng-IoT-project\src\assets）最尾部都不会包含“\”。<br />
 * 7、当设置文件夹的路径别名时，用path.join设置时，其值如果包含最后的“/”，则最后生成的路径（如：G:\WebStormWS\web-hansheng-IoT-project\src\assets\）最尾部就会包含“\”，反之不会。<br />
...
\n` );
  ...
  moduleConfig = ( {
          ...
          return isProduction
              ...
              [
                'minify',
                {
                   ...
                   * TypeError: G:\WebStormWS\web-hansheng-IoT-project\src\pages\index\Index.mts: Cannot read properties of undefined (reading 'getCode')
                   *     at NodePath.getSource (G:\WebStormWS\web-hansheng-IoT-project\node_modules\@babel\traverse\lib\path\introspection.js:137:27)
                   *     at PluginPass.exit (G:\WebStormWS\web-hansheng-IoT-project\node_modules\babel-plugin-minify-mangle-names\lib\index.js:543:45)
                   *     at newFn (G:\WebStormWS\web-hansheng-IoT-project\node_modules\@babel\traverse\lib\visitors.js:172:14)
                   */
                  /*
                   mangle: {
                   exclude: {},
      ...
      cssLoader = {
        ...
        options: {
          ...
          url: {
             ...
             *
             * @param {string} resourcePath css文件的路径，值形如：G:\WebStormWS\web-hansheng-IoT-project\src\pages\index\Index.css。<br />
             *
    ...
    return {
       ...
       * path.join( __dirname, './src/assets/' )，最后解析成：G:\WebStormWS\web-hansheng-IoT-project\src\assets\
       * 有或是没有最后的“\”在具体应用时很重要！不然容易出现不如你所愿的现象。<br />
       * 2、当设置文件夹的路径别名时，用path.resolve设置时，其值包不包含最后的“/”都没关系，因为最后生成的路径（如：G:\WebStormWS\web-hansheng-IoT-project\src\assets）都不会包含“\”。<br />
       * 3、当设置文件夹的路径别名时，用path.join设置时，其值如果包含最后的“/”，则最后生成的路径（如：G:\WebStormWS\web-hansheng-IoT-project\src\assets\）就会包含“\”，反之不会。<br />
       * 4、设置文件夹的路径别名时，建议使用path.resolve，这样在后续使用路径别名时，就可以按正常的习惯使用：import JSONDemo001 from 'jsonDir/Demo001.json';<br />
       * 5、设置各个loader的include、exclude选项时，最好用path.join，因为webpack在处理exclude选项的值时，会用字符串的“startsWith”方法进行匹配，此时，最后生成的路径（如：G:\WebStormWS\web-hansheng-IoT-project\src\assets\）最尾部包不包含“\”会起到很大的区别。<br />
       ...
       * str：G:\WebStormWS\web-hansheng-IoT-project\src\assets\doc\json5\Demo001.json5<br />
       * condition：G:\WebStormWS\web-hansheng-IoT-project\src\assets\doc\json5\<br />
       */
      rules: [
        // 处理.cson文件。
        {
          ...
          use: [
             ...
             */
            {
              ...
              options: {
                 ...
                 *     at registerBinding (G:\WebStormWS\web-hansheng-IoT-project\node_modules\@vue\compiler-sfc\dist\compiler-sfc.cjs.js:4653:19)
                 *     at walkObjectPattern (G:\WebStormWS\web-hansheng-IoT-project\node_modules\@vue\compiler-sfc\dist\compiler-sfc.cjs.js:4734:13)
                 *     at walkDeclaration (G:\WebStormWS\web-hansheng-IoT-project\node_modules\@vue\compiler-sfc\dist\compiler-sfc.cjs.js:4698:21)
                 *     at Object.compileScript (G:\WebStormWS\web-hansheng-IoT-project\node_modules\@vue\compiler-sfc\dist\compiler-sfc.cjs.js:4263:13)
                 *     at resolveScript (file:///G:/WebStormWS/web-hansheng-IoT-project/node_modules/@vitejs/plugin-vue/dist/index.mjs:283:31)
                 *     at genScriptCode (file:///G:/WebStormWS/web-hansheng-IoT-project/node_modules/@vitejs/plugin-vue/dist/index.mjs:2469:18)
                 *     at transformMain (file:///G:/WebStormWS/web-hansheng-IoT-project/node_modules/@vitejs/plugin-vue/dist/index.mjs:2282:54)
                 *     at Object.transform (file:///G:/WebStormWS/web-hansheng-IoT-project/node_modules/@vitejs/plugin-vue/dist/index.mjs:2785:16)
                 *     at file:///G:/WebStormWS/web-hansheng-IoT-project/node_modules/rollup/dist/es/shared/node-entry.js:24551:40
                 */
                ...( isEnabled => {
                  return isEnabled
                         ? {
  ...
  moduleFederationPluginConfig = {
     ...
     */
    name: 'Webpack5_MF2_Main_HanSheng_IoT',
    /**
     * 确定生成的remoteEntry的文件名。非必须。<br />
     * 1、默认值：'remoteEntry.js'。<br />
     * 2、作为“output.path”目录内的相对路径。<br />
     * 例如，可以设置为：'js/Webpack5_MF2_Main_HanSheng_IoT.js'，表示生成的JS文件路径会是：'${ output.path }/js/Webpack5_MF2_Main_HanSheng_IoT.js'。<br />
     * 3、一般来说，设置了该选项的，就表示其是一个远端模块提供者（也叫做：远端模块分享者之类的，当然远端模块提供者也是可以使用其他的远端模块提供者提供的远端模块）。<br />
     */
    // filename: 'Webpack5_MF2_Main_HanSheng_IoT.js',
    /**
    ...
    manifest: {
       ...
       * 1、如果设置了，那请求路径形如：<br />
       * https://localhost:8100/dev_server/mf2-json/Webpack5_MF2_Main_HanSheng_IoT-manifest.json
       * https://localhost:8100/dev_server/mf2-json/Webpack5_MF2_Main_HanSheng_IoT-manifest-stats.json
       */
      // filePath: 'mf2-json',
      /**
       * 同时还会有一个名为：Webpack5_MF2_Main_HanSheng_IoT-manifest-stats.json的文件。<br />
       * 1、如果设置了，那请求路径形如：<br />
       * https://localhost:8100/dev_server/Webpack5_MF2_Main_HanSheng_IoT-manifest.json
       * https://localhost:8100/dev_server/Webpack5_MF2_Main_HanSheng_IoT-manifest-stats.json
       */
      fileName: 'Webpack5_MF2_Main_HanSheng_IoT-manifest.json',
